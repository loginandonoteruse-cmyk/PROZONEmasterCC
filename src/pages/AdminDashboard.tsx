  ...
  const handleUpdateSettings = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (sizeInBytes > 900000) {
        setErrorMessage(`Error: Settings are too large (${(sizeInBytes / 1024 / 1024).toFixed(2)} MB). Please use smaller images or image URLs instead of uploading files.`);
      ...
      console.error(err);
      setErrorMessage('Failed to save settings. If you uploaded large images, try using smaller ones or image URLs.');
      setTimeout(() => setErrorMessage(''), 6000);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 p-8 overflow-y-auto relative">
        ...
        {errorMessage && (
          <div className="absolute top-8 right-8 bg-red-50 text-red-600 px-4 py-2 rounded-lg border border-red-100 shadow-sm z-50 max-w-md">
            {errorMessage}
          </div>
        )}
        {activeTab === 'settings' && (
